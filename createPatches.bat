...
svn list https://213.144.28.209:444/svn/ingrid/ingrid-iplug-csw-dsc/tags
set /p tag="Enter tag-version (e.g. 3.3.0): "

set COUNT=0
set svnCall=svn log --limit 1 https://213.144.28.209:444/svn/ingrid/ingrid-iplug-csw-dsc/tags/ingrid-iplug-csw-dsc-%tag%
